...
Помимо конфиденциальности, Paranoia делает упор на **скрытность**: служебный, административный и голосовой трафик заворачивается в маскировочный (cover) слой, так что для внешнего наблюдателя соединение выглядит как обычный HTTPS к обычному сайту. Цель — повысить стоимость детекции, а не добиться доказуемой неотличимости.

> Полная модель угроз, обоснование решений и остающиеся ограничения: **[docs/SECURITY-MODEL.md](docs/SECURITY-MODEL.md)**.
...
- [Экспортный комплаенс](EXPORT_COMPLIANCE.md) · [Отказ от ответственности](DISCLAIMER.md) · [Политика безопасности](SECURITY.md)
