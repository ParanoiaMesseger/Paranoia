...
public:
    ...
    // диалогов по свежести (по дате последнего сообщения). Обновляется при отправке/получении
    ...
    // Последний выбранный фильтр темы (ветки) для этого диалога — восстанавливается
