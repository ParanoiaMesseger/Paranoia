...
namespace Utils
{
    ...
    QVariantMap errorResult(const QString &message) { return QVariantMap{{"ok", false}, {"error", message}}; }

    QVariantMap lastRustErrorResult() { return errorResult(lastRustError()); }
